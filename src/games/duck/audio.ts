/**
 * Duck szn's noises, synthesised rather than shipped.
 *
 * The project has no audio assets and a shooting gallery needs feedback on
 * every trigger pull, so these are built from oscillators and a little noise
...
type Sound = 'shot' | 'miss' | 'pop' | 'ding' | 'clank' | 'burst' | 'bark' | 'penalty' | 'rescue'
