...
const CASE: GameEntry = {
  id: 'case-closed',
  title: 'Case Closed',
  tagline: "Basically Clue, if Clue's mansion had a mess hall.",
  genre: 'Deduction',
  players: '3-6 players',
  status: 'live',
  blurb:
    'Someone at camp did something, with something, somewhere. Everyone gets a hand of clue cards; whatever is left over is the answer, sealed away until someone accuses correctly.',
  plan: [
    'Nine rooms in a classic 3x3 layout, two diagonal secret passages, dice-roll movement.',
    'Suggest a suspect and a weapon in whatever room you are standing in; the table checks hands in turn, quietly, until someone can disprove it.',
    'Accuse any time you are confident - right and you win outright, wrong and you are out for good (though you keep disproving others).',
    'The deck and the solution never touch a browser until the case is closed - the relay itself deals the hands, since the host is also a player.',
  ],
  art: (ctx, frame) => {
