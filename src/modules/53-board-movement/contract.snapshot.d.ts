...
export { acknowledgeBoardRound, getBoardMovement, isBoardRoundAcknowledged, listenForBoardMovement, requestBoardRoll, resetBoardMovement, resumeBoardMovement, setBoardDiceProvider, syncBoardMovementLifecycle, useBoardMovement, useBoardRoundAcknowledged, type BoardDiceProvider, } from './internal/state';
