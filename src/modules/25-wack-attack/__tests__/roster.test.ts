...
import { MAX_WHACKERS, SOLO_WHACKERS, gameRoster, newGame } from '../internal/setup'
...
describe('the roster in a lobby', () => {
  ...
  it('is you and stand-ins when nobody else has arrived', () => {
    ...
    expect(roster).toHaveLength(SOLO_WHACKERS)
  ...
  it('stops at eight', () => {
    ...
    expect(gameRoster()).toHaveLength(MAX_WHACKERS)
  })
})
