/**
 * Who is dealt a spot on the bank while in a lobby.
 */
...
import { MAX_FEEDERS, SOLO_FEEDERS, gameRoster, newGame } from '../internal/setup'
...
describe('the roster in a lobby', () => {
  ...
  it('is you and stand-ins when nobody else has arrived', () => {
    ...
    expect(roster).toHaveLength(SOLO_FEEDERS)
  ...
  it('stops at eight', () => {
    ...
    expect(gameRoster()).toHaveLength(MAX_FEEDERS)
  })
})
