/**
 * Putting a game together: who is in the room.
 *
...
export const ME = 'you'
/** You and four stand-ins: somebody to get in your way. */
...
/** A seed for the bombs, and so an id to tell games apart. */
export function nextSeed(): number {
  dealt += 1
  return hashSeed(CONVENTIONS.worldSeed, `youre-the-bomb:${getNet().room ?? 'solo'}:${dealt}:${Date.now()}`)
}
