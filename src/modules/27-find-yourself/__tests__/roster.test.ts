/**
 * Who is dealt a cup while in a lobby.
 */
...
import { MAX_FINDERS, SOLO_FINDERS, gameRoster, newGame } from '../internal/setup'
...
describe('the roster in a lobby', () => {
  ...
  it('is you and stand-ins when nobody else has arrived', () => {
    ...
    expect(roster).toHaveLength(SOLO_FINDERS)
  ...
  it('stops at eight', () => {
    ...
    expect(gameRoster()).toHaveLength(MAX_FINDERS)
  })
})
