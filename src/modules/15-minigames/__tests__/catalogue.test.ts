...
describe('the catalogue', () => {
  ...
  it('knows the built games are part built and nothing else has started', () => {
    ...
    for (const id of ['zombie-tag', 'messy-maze', 'probable-stop', 'duck-hunt', 'feeding-time', 'sprint-triathlon', 'punch-buggy', 'time-it', 'wack-attack', 'lady-luck', 'find-yourself', 'make-the-cut', 'hes-one-shot', 'let-him-cook', 'i-see-the-light', 'helping-dad', 'synchronize-steps'] as const) {
    ...
    expect(started).toEqual(['zombie-tag', 'messy-maze', 'probable-stop', 'duck-hunt', 'feeding-time', 'sprint-triathlon', 'punch-buggy', 'time-it', 'wack-attack', 'lady-luck', 'find-yourself', 'make-the-cut', 'hes-one-shot', 'let-him-cook', 'i-see-the-light', 'helping-dad', 'synchronize-steps'])
