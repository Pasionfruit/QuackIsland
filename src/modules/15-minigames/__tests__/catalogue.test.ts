...
describe('the catalogue', () => {
  ...
  it('knows the built games are part built and nothing else has started', () => {
    ...
    for (const id of ['zombie-tag', 'messy-maze', 'probable-stop', 'duck-hunt', 'punch-buggy', 'wack-attack', 'lady-luck', 'make-the-cut', 'let-him-cook', 'i-see-the-light'] as const) {
    ...
    expect(started).toEqual(['zombie-tag', 'messy-maze', 'probable-stop', 'duck-hunt', 'punch-buggy', 'wack-attack', 'lady-luck', 'make-the-cut', 'let-him-cook', 'i-see-the-light'])
