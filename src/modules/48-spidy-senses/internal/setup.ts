/**
 * Putting a game together: who is round the trapdoor.
 *
...
export const ME = 'you'
/** You and five stand-ins: five to outlast. */
...
/** A cellar with nobody in it yet, for a guest to hold until the host's first snapshot. */
